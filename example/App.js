...
function Home() {
  return (
    <div>
      ...
      <Link to="/labelSelect">LabelSelect</Link>
      <Link to="/searchInput">SearchInput</Link>
      <Link to="/MiniSearchInput">MiniSearchInput</Link>
      <Link to="/checkbox">Checkbox</Link>
      <Link to="/quickFilter">QuickFilter</Link>
      <Link to="/smartInput">SmartInput</Link>
    </div>
  );
}
    ...
    return (
      <Suspense fallback={<div>Loading...</div>}>
        <Switch>
          ...
          <Route path="/labelSelect" component={getComponent("LabelSelect")} />
          <Route path="/searchInput" component={getComponent("SearchInput")} />
          <Route
            path="/MiniSearchInput"
            component={getComponent("MiniSearchInput")}
          />
          <Route path="/checkbox" component={getComponent("Checkbox")} />
          <Route path="/quickFilter" component={getComponent("QuickFilter")} />
          <Route path="/smartInput" component={getComponent("SmartInput")} />
        </Switch>
      </Suspense>
    );
  }
